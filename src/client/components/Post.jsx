...
const Post = (props) => {
  ...
  // post info
  const {
    createdBy, resolvedBy, problem, expect, tried, suspect, topic, status, userid, helperid, studentid, statusid, postid,
  } = props;
  // eventHandlers
    ...
    <div style={style.post}>
      ...
      <div className="footer">
        ...
        <button
          ...
          onClick={() => changeStatus(props.userid, props.status, props.postid, props.role)}
        >
          {' '}
          {status}
          {' '}
