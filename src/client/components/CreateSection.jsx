...
const CreateSection = (props) => {
  console.log(props.user_id, 'createPost')
  const divStyle = {
  ...
  return (
    <div style={divStyle}>
      ...
      <input onChange={props.onProblem} type="text" placeholder="" value={props.problem} />
      <br />
      <label style={labelStyle}>What did I expect to happen: </label>
      <input onChange={props.onExpect} type="text" placeholder="" value={props.expect} />
      <br />
      <label style={labelStyle}>What have I tried: </label>
      <input onChange={props.onTried} type="text" placeholder="" value={props.tried} />
      <br />
      <label style={labelStyle}>Why I suspect its not working: </label>
      <input onChange={props.onSuspect} type="text" placeholder="" value={props.suspect} />
      <br />
      ...
      <div>
        <button
          style={buttonStyle}
          type="submit"
          onClick={() => props.onCreateSectionSubmit(props.user_id, props.problem, props.expect, props.tried, props.suspect, props.topic)
            }
        >
          Submit
        </button>
